...
REPLACE INTO `spanish_places` (`id`, `name`, `latitude`, `longitude`, `parentid`, `type`) VALUES
	(2187, 'Barcelona Institute of Science and Technology (BIST)', '41.3888281', '2.1491666', NULL, 'iEchor'),
	(595, 'Barcelona Supercomputing Center', '41.3893997', '2.116153', NULL, 'iEchor'),
	...
	(285, 'Centre for Genomic Regulation (CRG)', '41.3853788', '2.1940517', NULL, 'iEchor'),
	...
	(20310, 'CNB (CSIC)', '40.544669', '-3.690266', NULL, 'iEchor'),
	...
	(618, 'Institute for Research in Biomedicine (IRB Barcelona)', '41.3822262', '2.1181', NULL, 'iEchor'),
	...
	(20321, 'Molecular Biology Institute of Barcelona (CSIC-)', '41.382623', '2.118456', NULL, 'iEchor'),
	(20251, 'National Center of Biotechnology (CSIC)', '40.4411076', '-3.6861518', '2259', NULL),
	(500, 'Spanish National Cancer Research Center (CNIO)', '40.476268', '-3.693884', NULL, 'iEchor'),
	...
	(561, 'Universitat Pompeu Fabra', '41.3789689', '2.1797941', NULL, 'iEchor'),
	(230, 'University of Barcelona', '41.386608', '2.16402', NULL, 'iEchor'),
	...
	(NULL, 'Institucio Catalana de Recerca i Estudis Avancats (ICREA)', '41.391115', '2.179451', NULL, 'iEchor'),
	(NULL, 'Universitat Autònoma de Barcelona', '41.501914', '2.104863', NULL, 'iEchor'),
	(NULL, 'Hospital Virgen del Rocío', '37.361783', '-5.980261', NULL, 'Other'),
	(NULL, 'Bellvitge Biomedical Research Institute (IDIBELL)', '41.345187', '2.110295', NULL, 'iEchor'),
	(NULL, 'Centro de Investigación Príncipe Felipe (CIPF)', '39.452', '-0.344', NULL, 'iEchor'),
	(NULL, 'Vall d\'Hebron Research Institute', '41.426', '2.141', NULL, 'iEchor'),
	(NULL, 'Hospital Universitario La Paz', '40.481', '-3.687', NULL, 'iEchor'),
	(NULL, 'Jaume I University', '39.994', '-0.068', NULL, 'Other'),
	(NULL, 'Institut d\'Investigacions Biomèdiques August Pi i Sunyer (IDIBAPS)', '41.388', '2.150', NULL, 'iEchor'),
	(NULL, 'Hospital Clinic', '41.389', '2.152', NULL, 'iEchor'),
	...
	(NULL, 'Hospital Sant Joan de Déu', '41.384', '2.102', NULL, 'iEchor'),
	...
	(NULL, 'Centro de Investigaciones Biológicas (CSIC)', '40.447', '-3.721', NULL, 'iEchor');
